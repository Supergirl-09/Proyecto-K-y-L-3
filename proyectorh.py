...
class RHApp:
    ...
    def mostrar_menu_universal(self):
        ...
        # Botones que llevan a los menús específicos
    ...
    def mostrar_menu_organizacional(self):
        ...
        # Botón para agregar o modificar los nuevos datos
    ...
    def agregar_expediente_form(self):
        ...
        # Usamos un Grid para alinear mejor los campos
    ...
    def mostrar_expedientes(self):
        ...
        # Se crea el Treeview con todas las columnas
        ...
        # Ajustes de ancho para una mejor visualización
